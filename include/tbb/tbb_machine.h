...
/* An efficient implementation of the reverse function utilizes a 2^8 lookup table
   holding the bit-reversed values
*/
template<typename T>
...
// Mapping historically used name to the expected by atomic_load_stored_traits
...
inline void __TBB_TryLockByteElided(__TBB_atomic_flag& flag) {
  for (;;) {
